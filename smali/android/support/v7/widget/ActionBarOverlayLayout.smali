...
.field private f:Landroid/support/v7/widget/n;
...
.field private w:Landroid/support/v4/widget/y;

.field private x:Landroid/support/v4/view/bb;

.field private final y:Landroid/support/v4/view/bf;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->y:Landroid/support/v4/view/bf;
...
.method static synthetic a(Landroid/support/v7/widget/ActionBarOverlayLayout;Landroid/support/v4/view/bb;)Landroid/support/v4/view/bb;
    .locals 0

    .prologue
    .line 50
    iput-object p1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->x:Landroid/support/v4/view/bb;

    return-object p1
.end method

.method private a(Landroid/view/View;)Landroid/support/v7/widget/n;
    .locals 3
...
.method private a(Landroid/content/Context;)V
    ...
    .line 150
    invoke-static {p1}, Landroid/support/v4/widget/y;->a(Landroid/content/Context;)Landroid/support/v4/widget/y;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Landroid/support/v4/widget/y;
...
.method private a(FF)Z
    ...
    .line 599
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Landroid/support/v4/widget/y;
    ...
    invoke-virtual/range {v0 .. v8}, Landroid/support/v4/widget/y;->a(IIIIIIII)V

    .line 600
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Landroid/support/v4/widget/y;

    invoke-virtual {v0}, Landroid/support/v4/widget/y;->e()I
...
.method static synthetic b(Landroid/support/v7/widget/ActionBarOverlayLayout;)Landroid/support/v4/view/bf;
    .locals 1

    .prologue
    .line 50
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->y:Landroid/support/v4/view/bf;
...
.method private k()V
    ...
    .line 573
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->x:Landroid/support/v4/view/bb;
    ...
    invoke-virtual {v0}, Landroid/support/v4/view/bb;->b()V
...
.method public a(I)V
    ...
    .line 627
    :sswitch_0
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->f:Landroid/support/v7/widget/n;

    invoke-interface {v0}, Landroid/support/v7/widget/n;->f()V
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/n;->g()V
...
.method public a(Landroid/view/Menu;Landroid/support/v7/view/menu/l$a;)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v7/widget/n;->a(Landroid/view/Menu;Landroid/support/v7/view/menu/l$a;)V
...
.method c()V
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->a(Landroid/view/View;)Landroid/support/v7/widget/n;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->f:Landroid/support/v7/widget/n;
...
.method public d()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/n;->h()Z
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v2}, Landroid/support/v4/view/ai;->j(Landroid/view/View;)F
...
.method public e()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/n;->i()Z
...
.method public f()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/n;->j()Z
...
.method protected fitSystemWindows(Landroid/graphics/Rect;)Z
    ...
    invoke-static {p0, v1, v2}, Landroid/support/v7/widget/ad;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method public g()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/n;->k()Z
...
.method public getActionBarHideOffset()I
    ...
    invoke-static {v0}, Landroid/support/v4/view/ai;->j(Landroid/view/View;)F
...
.method public getTitle()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/n;->e()Ljava/lang/CharSequence;
...
.method public h()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/n;->l()Z
...
.method public i()V
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/n;->m()V
...
.method public j()V
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/n;->n()V
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 219
    invoke-static {p0}, Landroid/support/v4/view/ai;->p(Landroid/view/View;)V
...
.method protected onMeasure(II)V
    ...
    invoke-static {v0}, Landroid/support/v4/view/ai;->i(Landroid/view/View;)I

    move-result v0

    invoke-static {v9, v0}, Landroid/support/v7/widget/ad;->a(II)I
    ...
    invoke-static {v2}, Landroid/support/v4/view/ai;->i(Landroid/view/View;)I

    move-result v2

    invoke-static {v9, v2}, Landroid/support/v7/widget/ad;->a(II)I
...
.method public setIcon(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/n;->a(I)V
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/n;->a(Landroid/graphics/drawable/Drawable;)V
...
.method public setLogo(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/n;->b(I)V
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/n;->a(Landroid/view/Window$Callback;)V
