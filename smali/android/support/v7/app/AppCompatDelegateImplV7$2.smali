...
.method public a(Landroid/view/View;Landroid/support/v4/view/bi;)Landroid/support/v4/view/bi;
    ...
    .prologue
    .line 430
    invoke-virtual {p2}, Landroid/support/v4/view/bi;->b()I
    ...
    .line 434
    invoke-virtual {p2}, Landroid/support/v4/view/bi;->a()I

    move-result v0

    invoke-virtual {p2}, Landroid/support/v4/view/bi;->c()I

    move-result v2

    invoke-virtual {p2}, Landroid/support/v4/view/bi;->d()I

    move-result v3

    invoke-virtual {p2, v0, v1, v2, v3}, Landroid/support/v4/view/bi;->a(IIII)Landroid/support/v4/view/bi;
